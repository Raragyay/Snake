# coding=utf-8
"""
This test is for the GUI.
We fill the screen and see if it works as intended.
"""
from unittest import TestCase

from snake.game import GameConfig
from snake.gui import GameWindow
from snake.map import Map, Pos, PointType


class TestGameWindow(TestCase):
